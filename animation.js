...
.tl-clip-entry .tl-clip-dot { width: 7px; height: 7px; border-radius: 50%; background: #ffb14a; flex-shrink: 0; }
...
.tl-clip-row { position: relative; height: 27px; margin-bottom: 4px; }
...
.tl-clip-block-label { font-size: 11px; font-weight: 700; color: #fff; text-shadow: 0 1px 2px rgba(0,0,0,.5); white-space: nowrap; }
