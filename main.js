    ...
    for (const entry of data.objects) {
        ...
        if (entry.userData?.isImportedModel && entry.modelData) {
            try {
                ...
                // Upgrade de material — ObjectLoader pode reconstruir Phong/Lambert
                // (de modelos OBJ antigos). Converte tudo para MeshStandard (PBR).
                ...
                obj.userData.originalFileName   = entry.userData?.originalFileName || '';
                let hasBones = false;
