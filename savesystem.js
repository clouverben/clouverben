...
class SaveSystem {
    ...
    _triggerDownload(bytes, filename) {
        // Converte para base64 e usa data URI — o browser SEMPRE respeita
        // o atributo download com data URIs, sem renomear para .bin
        let binary = '';
        const chunk = 8192;
        ...
        a.href     = 'data:application/x-nexus-project;base64,' + b64;
        a.download = filename;
